...
def tight_coupling_twoway(config_1, config_2, config_3):
    """
    ...
    for yr in range(start_yr, end_yr + step, step):
        ...
        model_1 = Prox(config=config_1,
                       model_name='tight_coupling_twoway_model_1',
                       target_yr=yr)
        # run model_1
        model_1.advance()
        model_1.close()
        ...
        model_2 = Prox( config=config_2,
                        model_name='tight_coupling_twoway_model_2',
                        target_yr=yr,
        ...
        model_3 = Prox( config=config_3,
                        model_name='tight_coupling_twoway_model_3',
                        target_yr=yr,
